 ...
 * NewJFrame.java
 *
 * Created on Oct 4, 2011, 9:46:09 PM
 */
...
try{
    ...
    stat=con.prepareStatement("INSERT INTO node_details VALUES(?,?,?)");
    node=jTextField1.getText().trim();
    ip=jTextField2.getText().trim();
    port=jTextField3.getText().trim();
    stat.setString(1,node);
    stat.setString(2,ip);
    stat.setString(3,port);
    stat.executeUpdate();
    jTextField1.setText("");
    jTextField2.setText("");
    jTextField3.setText("");
